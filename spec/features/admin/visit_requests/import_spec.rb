RSpec.describe 'Visit Requests APPROVE' do
  ...
  let(:user_a)           { create(:profiling_user, first_name: 'A', last_name: 'User') }
  let(:user_b)           { create(:profiling_user, first_name: 'B', last_name: 'User') }
  let(:user_c)           { create(:profiling_user, first_name: 'C', last_name: 'User') }
