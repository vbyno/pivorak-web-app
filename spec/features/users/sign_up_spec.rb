RSpec.describe 'Users Sign Up' do
  ...
  context 'when params are valid' do
    it 'creates user' do
      ...
      expect { click_button 'Sign up' }.to change(Authentication::User, :count).by(1)

      new_user = Profiling::User.last
    ...
    context 'when creating user with the same first_name and last_name' do
      it 'creates user with correct slug' do
        ...
        create(:profiling_user, first_name: first_name, last_name: last_name)
  ...
  context 'when params are invalid' do
    it 'validates errors' do
      ...
      expect { click_button 'Sign up' }.to change(Authentication::User, :count).by(0)
